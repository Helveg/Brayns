...
VasculatureInstance::VasculatureInstance(const brayns::Vector3f& start, const float startR,
                                         const brayns::Vector3f& end, const float endR,
                                         const VasculatureSection sectionType)
 : _geometry(brayns::createSDFConePill(start, end, startR, endR))//_geometry(start, end, startR, endR)
