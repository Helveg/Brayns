 ...
 *        to read 'astrocyte' node population types
 */
class AstrocytePopulationLoader : public NodePopulationLoader
{
public:
    AstrocytePopulationLoader(bbp::sonata::NodePopulation&& population,
