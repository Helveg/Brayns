...
{
/**
 * @brief The SonataSelection class is in charge of creating the selection of nodes that
...
/**
 * @brief The SonataSelection class is in charge of creating the selection of edges that
 *        will be loaded into brayns, taking into account user parameters and network
 *        data.
 */
class EdgeSelection
...
public:
    /**
     * @brief EdgeSelection initially start with the edges selected from a given node network
     */
