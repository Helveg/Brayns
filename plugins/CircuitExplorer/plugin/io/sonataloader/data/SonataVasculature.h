...
{
/**
 * @brief The SonataVasculature class is in charge of quering vasculature dataset information from
...
public:
    ...
    /**
     * @brief returns a list of 3D segment start points for the given node selection
     */
    static std::vector<brayns::Vector3f>
    getSegmentStartPoints(const Nodes& nodes, const Selection& selection);

    /**
     * @brief returns a list of 3D segment end points for the given node selection
     */
    static std::vector<brayns::Vector3f>
