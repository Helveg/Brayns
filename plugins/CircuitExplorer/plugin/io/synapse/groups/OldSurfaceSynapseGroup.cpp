...
void OldSurfaceSynapseGroup::mapSimulation(const std::unordered_map<uint64_t, uint64_t>& mapping)
{
...
ElementMaterialMap::Ptr OldSurfaceSynapseGroup::addToModel(brayns::Model& model) const
{
