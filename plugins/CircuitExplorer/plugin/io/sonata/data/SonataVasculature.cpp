...
std::vector<brayns::Vector3f> getPoints(const bbp::sonata::NodePopulation& nodes,
...
{
    checkAttributes(nodes, {attribSectionId});
...
{
    checkAttributes(nodes, {attribStartNode});
...
{
    checkAttributes(nodes, {attribEndNode});
