...
const brayns::Vector3f& ColorDeck::getColorForKey(const std::string& k) noexcept
{
...
const brayns::Vector3f& ColorDeck::emplaceColor(const std::string& k) noexcept
{
...
const brayns::Vector3f& ColorRoulette::getNextColor() noexcept
{
